  ...
  return (
    <div className="mx-auto max-w-5xl">
      <header className="mb-6">
        ...
        <h1 className="text-xl font-semibold">Past analysis</h1>
      </header>
      <div className="rounded-lg border border-dashed border-slate-300 p-8 text-sm text-slate-600">
        ...
        <p className="mt-2">
          Replaying a date window through the simulation (SOC timelines, charge sessions, unsafe
          days) runs for minutes, so it needs the job-queue API endpoints first. Until then this
          view lives in the Streamlit app.
        </p>
      </div>
    </div>
  );
